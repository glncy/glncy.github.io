<template>
  <div class="page-wrapper">
    <div class="hero-wrapper">
      <div class="title" v-if="error.statusCode === 404">Page not found</div>
      <div class="title" v-else>An error occurred</div>
      <div class="short-description" v-if="error.statusCode === 404">
        Uh oh. Looks like I don't have this page yet.
      </div>
      <div class="short-description" v-else>
        Uh oh. Sorry. Don't worry, I'll get it fixed soon.
      </div>
    </div>
    <nuxt-link to="/">
      <div class="cta">
